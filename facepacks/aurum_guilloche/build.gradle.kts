...
// Resource-only WFP face packaging for Aurum Guilloche. WFF resources are copied from
...
android {
    namespace = "com.dialed.app.watchfacepush.aurum.guilloche"
    compileSdk = 36

    defaultConfig {
        applicationId = "com.dialed.app.watchfacepush.aurum.guilloche"     // WFP rule: <marketplaceAppId>.watchfacepush.<name>
        minSdk = 33
        targetSdk = 33
        versionCode = 1
        versionName = "1.0"
    ...
    sourceSets["main"].manifest.srcFile("$rootDir/faces/Aurum-Guilloche/app/src/main/AndroidManifest.xml")
