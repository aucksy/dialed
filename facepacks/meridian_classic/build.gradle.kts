...
// Resource-only WFP face packaging for Meridian Classic. WFF resources are copied from
...
android {
    namespace = "com.dialed.app.watchfacepush.meridian.classic"
    compileSdk = 36

    defaultConfig {
        applicationId = "com.dialed.app.watchfacepush.meridian.classic"     // WFP rule: <marketplaceAppId>.watchfacepush.<name>
        minSdk = 33
        targetSdk = 33
        versionCode = 1
        versionName = "1.0"
    ...
    sourceSets["main"].manifest.srcFile("$rootDir/faces/Meridian-Classic/app/src/main/AndroidManifest.xml")
