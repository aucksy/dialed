...
// Resource-only WFP face packaging for Meridian PetiteSeconde. WFF resources are copied from
...
android {
    namespace = "com.dialed.app.watchfacepush.meridian.petiteseconde"
    compileSdk = 36

    defaultConfig {
        applicationId = "com.dialed.app.watchfacepush.meridian.petiteseconde"     // WFP rule: <marketplaceAppId>.watchfacepush.<name>
        minSdk = 33
        targetSdk = 33
        versionCode = 1
        versionName = "1.0"
    ...
    sourceSets["main"].manifest.srcFile("$rootDir/faces/Meridian-PetiteSeconde/app/src/main/AndroidManifest.xml")
