...
// Resource-only WFP face packaging for Terra Altimeter. WFF resources are copied from
...
android {
    namespace = "com.dialed.app.watchfacepush.terra.altimeter"
    compileSdk = 36

    defaultConfig {
        applicationId = "com.dialed.app.watchfacepush.terra.altimeter"     // WFP rule: <marketplaceAppId>.watchfacepush.<name>
        minSdk = 33
        targetSdk = 33
        versionCode = 1
        versionName = "1.0"
    ...
    sourceSets["main"].manifest.srcFile("$rootDir/faces/Terra-Altimeter/app/src/main/AndroidManifest.xml")
