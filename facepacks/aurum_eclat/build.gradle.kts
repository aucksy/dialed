...
// Resource-only WFP face packaging for Aurum Eclat. WFF resources are copied from
...
android {
    namespace = "com.dialed.app.watchfacepush.aurum.eclat"
    compileSdk = 36

    defaultConfig {
        applicationId = "com.dialed.app.watchfacepush.aurum.eclat"     // WFP rule: <marketplaceAppId>.watchfacepush.<name>
        minSdk = 33
        targetSdk = 33
        versionCode = 1
        versionName = "1.0"
    ...
    sourceSets["main"].manifest.srcFile("$rootDir/faces/Aurum-Eclat/app/src/main/AndroidManifest.xml")
