...
// Resource-only WFP face packaging for Settype Halftone. WFF content is reused
// straight from the fablecollection submodule; only the applicationId changes.
plugins { id("com.android.application") }

android {
    namespace = "com.dialed.app.watchfacepush.settype.halftone"
    compileSdk = 36

    defaultConfig {
        applicationId = "com.dialed.app.watchfacepush.settype.halftone"     // WFP rule: <marketplaceAppId>.watchfacepush.<name>
        minSdk = 33
        targetSdk = 33
        versionCode = 1
        versionName = "1.0"
    ...
    sourceSets["main"].res.setSrcDirs(listOf("$rootDir/faces/Settype-Halftone/app/src/main/res"))
    sourceSets["main"].manifest.srcFile("$rootDir/faces/Settype-Halftone/app/src/main/AndroidManifest.xml")
