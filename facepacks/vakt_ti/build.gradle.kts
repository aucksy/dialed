...
// Resource-only WFP face packaging for Vakt Ti. WFF resources are copied from
...
android {
    namespace = "com.dialed.app.watchfacepush.vakt.ti"
    compileSdk = 36

    defaultConfig {
        applicationId = "com.dialed.app.watchfacepush.vakt.ti"     // WFP rule: <marketplaceAppId>.watchfacepush.<name>
        minSdk = 33
        targetSdk = 33
        versionCode = 1
        versionName = "1.0"
    ...
    sourceSets["main"].manifest.srcFile("$rootDir/faces/Vakt-Ti/app/src/main/AndroidManifest.xml")
