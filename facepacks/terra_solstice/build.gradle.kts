...
// Resource-only WFP face packaging for Terra Solstice. WFF resources are copied from
...
android {
    namespace = "com.dialed.app.watchfacepush.terra.solstice"
    compileSdk = 36

    defaultConfig {
        applicationId = "com.dialed.app.watchfacepush.terra.solstice"     // WFP rule: <marketplaceAppId>.watchfacepush.<name>
        minSdk = 33
        targetSdk = 33
        versionCode = 1
        versionName = "1.0"
    ...
    sourceSets["main"].manifest.srcFile("$rootDir/faces/Terra-Solstice/app/src/main/AndroidManifest.xml")
