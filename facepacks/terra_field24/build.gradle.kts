...
// Resource-only WFP face packaging for Terra Field24. WFF resources are copied from
...
android {
    namespace = "com.dialed.app.watchfacepush.terra.field24"
    compileSdk = 36

    defaultConfig {
        applicationId = "com.dialed.app.watchfacepush.terra.field24"     // WFP rule: <marketplaceAppId>.watchfacepush.<name>
        minSdk = 33
        targetSdk = 33
        versionCode = 1
        versionName = "1.0"
    ...
    sourceSets["main"].manifest.srcFile("$rootDir/faces/Terra-Field24/app/src/main/AndroidManifest.xml")
