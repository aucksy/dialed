...
// Resource-only WFP face packaging for Halo Orbit. WFF resources are copied from
...
android {
    namespace = "com.dialed.app.watchfacepush.halo.orbit"
    compileSdk = 36

    defaultConfig {
        applicationId = "com.dialed.app.watchfacepush.halo.orbit"     // WFP rule: <marketplaceAppId>.watchfacepush.<name>
        minSdk = 33
        targetSdk = 33
        versionCode = 1
        versionName = "1.0"
    ...
    sourceSets["main"].manifest.srcFile("$rootDir/faces/Halo-Orbit/app/src/main/AndroidManifest.xml")
