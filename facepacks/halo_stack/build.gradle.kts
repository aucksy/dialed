...
// Resource-only WFP face packaging for Halo Stack. WFF resources are copied from
...
android {
    namespace = "com.dialed.app.watchfacepush.halo.stack"
    compileSdk = 36

    defaultConfig {
        applicationId = "com.dialed.app.watchfacepush.halo.stack"     // WFP rule: <marketplaceAppId>.watchfacepush.<name>
        minSdk = 33
        targetSdk = 33
        versionCode = 1
        versionName = "1.0"
    ...
    sourceSets["main"].manifest.srcFile("$rootDir/faces/Halo-Stack/app/src/main/AndroidManifest.xml")
