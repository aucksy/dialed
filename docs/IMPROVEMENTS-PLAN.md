...
| 6 Carousel/favorites | v0.9.0 | ⬜ | R4 DEFINITIVE: **no favorites/carousel API**; slot=1; only lever = bundling a **default watch face** → seeds ONE tile in the system gallery. Merges with the Phase-5 default-face work. |
