...
// Resource-only WFP face packaging for Halo Quadrant. WFF resources are copied from
...
android {
    namespace = "com.dialed.app.watchfacepush.halo.quadrant"
    compileSdk = 36

    defaultConfig {
        applicationId = "com.dialed.app.watchfacepush.halo.quadrant"     // WFP rule: <marketplaceAppId>.watchfacepush.<name>
        minSdk = 33
        targetSdk = 33
        versionCode = 1
        versionName = "1.0"
    ...
    sourceSets["main"].manifest.srcFile("$rootDir/faces/Halo-Quadrant/app/src/main/AndroidManifest.xml")
