...
// Resource-only WFP face packaging for Arclight Pulsar. WFF content is reused
// straight from the fablecollection submodule; only the applicationId changes.
plugins { id("com.android.application") }

android {
    namespace = "com.dialed.app.watchfacepush.arclight.pulsar"
    compileSdk = 36

    defaultConfig {
        applicationId = "com.dialed.app.watchfacepush.arclight.pulsar"     // WFP rule: <marketplaceAppId>.watchfacepush.<name>
        minSdk = 33
        targetSdk = 33
        versionCode = 1
        versionName = "1.0"
    ...
    sourceSets["main"].res.setSrcDirs(listOf("$rootDir/faces/Arclight-Pulsar/app/src/main/res"))
    sourceSets["main"].manifest.srcFile("$rootDir/faces/Arclight-Pulsar/app/src/main/AndroidManifest.xml")
