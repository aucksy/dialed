...
// Resource-only WFP face packaging for Settype Counterform. WFF content is reused
// straight from the fablecollection submodule; only the applicationId changes.
plugins { id("com.android.application") }

android {
    namespace = "com.dialed.app.watchfacepush.settype.counterform"
    compileSdk = 36

    defaultConfig {
        applicationId = "com.dialed.app.watchfacepush.settype.counterform"     // WFP rule: <marketplaceAppId>.watchfacepush.<name>
        minSdk = 33
        targetSdk = 33
        versionCode = 1
        versionName = "1.0"
    ...
    sourceSets["main"].res.setSrcDirs(listOf("$rootDir/faces/Settype-Counterform/app/src/main/res"))
    sourceSets["main"].manifest.srcFile("$rootDir/faces/Settype-Counterform/app/src/main/AndroidManifest.xml")
