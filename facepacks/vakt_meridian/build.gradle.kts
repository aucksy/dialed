...
// Resource-only WFP face packaging for Vakt Meridian. WFF resources are copied from
...
android {
    namespace = "com.dialed.app.watchfacepush.vakt.meridian"
    compileSdk = 36

    defaultConfig {
        applicationId = "com.dialed.app.watchfacepush.vakt.meridian"     // WFP rule: <marketplaceAppId>.watchfacepush.<name>
        minSdk = 33
        targetSdk = 33
        versionCode = 1
        versionName = "1.0"
    ...
    sourceSets["main"].manifest.srcFile("$rootDir/faces/Vakt-Meridian/app/src/main/AndroidManifest.xml")
